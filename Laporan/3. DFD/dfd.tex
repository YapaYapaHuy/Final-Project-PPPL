...
\begin{document}
	...
	\begin{figure}[H]
		\centering{\includegraphics[width=500px]{./level_context.png}}
	\end{figure}
	\begin{figure}[H]
		\centering{\includegraphics[width=500px]{./level_1.png}}
	\end{figure}
	\begin{figure}[H]
		\centering{\includegraphics[width=500px]{./level_2.png}}
	\end{figure}
\end{document}